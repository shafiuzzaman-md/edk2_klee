; Query 0 -- Type: InitialValues, Instructions: 13469
...
(check-sat)
(exit)
;   OK -- Elapsed: 4.426957e-03s
;   Solvable: true

; Query 1 -- Type: InitialValues, Instructions: 13469
; This file conforms to SMTLIBv2 and was generated by KLEE
...
(get-value ( (select CommBufferSize (_ bv7 32) ) ) )
(exit)
;   OK -- Elapsed: 7.005073e-03s
;   Solvable: true
;     CommBufferSize = [128,0,0,0,0,0,0,0]

; Query 3 -- Type: InitialValues, Instructions: 13578
; This file conforms to SMTLIBv2 and was generated by KLEE
(set-option :produce-models true)
(set-logic QF_AUFBV )
; Array declarations
